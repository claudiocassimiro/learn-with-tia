    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <CardHeader>
          ...
          <CardDescription>
            Escolha como você prefere aprender. O TIAcher vai adaptar todas as
            respostas ao seu estilo!
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex justify-end space-x-2 pt-4 border-t border-blue-600">
            <Button
              variant="outline"
              onClick={onClose}
              className="border-blue-600 bg-white hover:bg-gray-100"
            >
              Cancelar
            </Button>
            <Button
