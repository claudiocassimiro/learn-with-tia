      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Seu professor de IA personalizado para aprender tecnologia de forma
            adaptada ao seu estilo de aprendizagem
          </p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <p className="text-gray-600 text-sm">
                Aprenda no seu ritmo com conteúdo adaptado ao seu estilo
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              <h3 className="font-semibold text-gray-900 mb-2">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <p className="text-gray-600 text-sm">
                Powered by inteligência artificial de última geração
              </p>
            </div>
            <p className="text-gray-600">Carregando dados do usuário...</p>
          </div>
